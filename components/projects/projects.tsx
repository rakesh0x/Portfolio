                            ...
                            <div key={columnIndex} className="flex flex-col gap-8 w-full max-w-md">
                                {column.map((project, index) => (
                                    <motion.div
                                        key={index}
                                        variants={item}
                                        className="flex flex-col item-center space-y-4 group relative overflow-hidden rounded-2xl border border-gray-700/50 bg-gray-800/30 backdrop-blur-md hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-500"
                                    >
